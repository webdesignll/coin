...
unlocked to sign the Mxcoin-Qt.app bundle.
...
allowing somebody to distribute a Mxcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the mxcoin-qt.exe file inside the installer had not been tampered with.
